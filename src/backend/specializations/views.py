...
from src.backend.specializations.schemas import CreateSpecialization, UpdateSpecialization, ShowSpecialization
from src.backend.specializations.services import SpecializationService
