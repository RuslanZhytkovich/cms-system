...
Revision ID: 41cf59495869
Revises: 
Create Date: 2024-01-07 20:02:39.985843
...
def upgrade() -> None:
    ...
    sa.Column('project_start_date', sa.Date(), server_default=sa.text('now()'), nullable=True),
    sa.Column('project_end_date', sa.Date(), server_default=sa.text('now()'), nullable=True),
    ...
    sa.Column('time_created', sa.Date(), server_default=sa.text('now()'), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
